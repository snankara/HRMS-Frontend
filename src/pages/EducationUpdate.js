...
export default function EducationUpdate(props) {

    
    let [educations, setEducations] = useState(props.curriculumVitae.educations)
    // educations = props.curriculumVitae.educations
        ...
        <div>
                    ...
                    <div key={`${education}-${i}`}>
                        <Row>
                            ...
                            <div className="btn-box">
                                ...
                                <Button className="btn-link" color="info" onClick={() => handleAddClick(...educations)}>
            ...
            {educations[0]?.schoolName !== "" && educations[0]?.department !== "" && educations[0]?.endDate !== "" && educations[0]?.jobPositionName !== "" &&
                <Button  className="btn-link" color="success" onClick={() => props.getEducation(educations)}>
                    <i className="now-ui-icons ui-1_check mr-1"></i>Eğitim Bilgilerini Güncelle</Button>
            }
        </div>
    )
}
