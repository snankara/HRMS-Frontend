...
export default function ExperienceUpdate(props) {

    let [experiences, setExperiences] = useState(props.curriculumVitae.experiences)
                ...
                return (
                    <div key={`${experience}-${i}`}>
                        ...
                        <div className="btn-box">
                            ...
                            <Button className="btn-link" color="info" onClick={() => handleAddClick(...experiences)}>
